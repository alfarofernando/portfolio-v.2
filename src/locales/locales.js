export const locales = {
  es: {
    ...
    project2Description:
      "Asumí el rol de líder de proyecto, coordinando un equipo de tres desarrolladores y supervisando tanto las tareas técnicas como las entregas del equipo. Diseñé la arquitectura del sistema y me encargué de las implementaciones más complejas, como el desarrollo completo del backend, que incluyó un sistema de autenticación con JWT y OAuth, y la lógica avanzada del frontend para el consumo de APIs RESTful. Este proyecto utilizó el stack MERN (MongoDB Atlas, Express, React, Node.js), lo que permitió un enfoque moderno, escalable y eficiente. También implementé estrategias de control de versiones con Git y GitHub, garantizando una colaboración efectiva entre los miembros del equipo. Como líder, adquirí experiencia en la gestión de tiempos y resolución de conflictos técnicos, logrando entregar un producto final que superó las expectativas iniciales.",
