            ...
            >
                ...
                >
                    <img
                        src={profile}
                        alt="Fernando"
                        className="w-64 h-64 object-cover border-4 border-gray-300 dark:border-gray-700 shadow-lg dark:hover:shadow-lg dark:hover:shadow-gray-300 rounded-full"
                    />
                </motion.div>
                ...
                >
                    <ul className="space-y-2">
                        <AnimatedContent keyProp={language}>
                            <motion.li whileHover={{ scale: 1.3, rotateY: 360, transition: { duration: 1.5, ease: "easeInOut" } }} className="transition-transform">
                                <h1 className="text-5xl font-bold p-1 dark:hover:shadow-md dark:hover:shadow-gray-500 rounded-full">
                                    <span>{locales[language].home1}{" "}</span>
                                    <span className="text-indigo-600 dark:text-indigo-400">Fernando</span> ✌
                                </h1>
                            </motion.li>
                            <motion.li whileHover={{ scale: 1.3, rotateY: -360, transition: { duration: 1.5, ease: "easeInOut" } }} className="transition-transform">
                                <h2 className="text-3xl font-semibold p-1  ">
                                    <span className="dark:hover:shadow-md dark:hover:shadow-gray-500 rounded-full px-2">🚀 {locales[language].home2}</span> </h2>
                            </motion.li>
                            <motion.li whileHover={{ scale: 1.3, rotateX: 360, transition: { duration: 1.5, ease: "easeInOut" } }} className="transition-transform">
                                <h3 className="text-2xl p-1 dark:hover:shadow-md dark:hover:shadow-gray-500 rounded-full ">{locales[language].home3} 🏆</h3>
                            </motion.li>
                            <motion.li whileHover={{ scale: 1.3, rotateX: -360, transition: { duration: 1.5, ease: "easeInOut" } }} className="transition-transform">
                    ...
                    <ul className="flex justify-center space-x-16 mt-6 ease ">
                        <motion.li whileHover={{ scale: 1.5, rotate: -1800 }} transition={{
                            ...
                            >
                                <svg className="w-16 h-16 dark:hover:shadow-md dark:hover:shadow-gray-300 rounded-full" fill="currentColor" viewBox="0 0 24 24">
